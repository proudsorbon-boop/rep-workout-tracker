...
export default function Profile() {
  ...
  const calculateCalories = () => {
    ...
    // Harris-Benedict Equation (Simplified for both)
          ...
          <CardContent className="space-y-4">
            ...
            {dailyCalories && (
              <div className="mt-6 p-4 rounded-xl bg-primary/10 border border-primary/20 text-center">
                <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold">Recommended Daily Intake</p>
                <h3 className="text-3xl font-display font-black text-primary mt-1">{dailyCalories} kcal</h3>
              </div>
            )}
          </CardContent>
        </Card>
